...
Once you have downloaded the Excel Interface, you can open it in Excel (Numbers). You will notice there are three sheets, labelled **Model**, **Settings**, and **Under the Hood**. Click on the **Model** tab. 
...
To run the model, you need to connect to the model first. There is a button at the top of the page which says **Connect to Model**. Click on that button. On the bottom left of the Excel window, you should see the text "Connecting to model..."
